namespace Common
{
	public static class TestConstants
	{
		...
		public const string EnvVarNameAzdoTestDbServer = @"AZDO_TEST_DB_INTEGRATED_SECURITY";
		public const string EnvVarNameAzdoTestDbPort = @"AZDO_TEST_DB_INTEGRATED_SECURITY";
		public const string EnvVarNameAzdoTestDbUserid = @"AZDO_TEST_DB_INTEGRATED_SECURITY";
